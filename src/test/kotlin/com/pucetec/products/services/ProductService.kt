...
class ProductServiceTest {
    ...
    /**
     * TODO TODO TEST TIENE UN CICLO DE VIDA
     *
     * @BEFORE ->
     * @BeforeAll -> ejecutarse antes de todos los tests.
     * @BeforeEach -> ejecutarse antes de cada test.
     *
     * TEST
     * @Test
     *
     * AFTER
     * @AfterAll -> ejecutarse despues de todos los tests.
     * @AfterEach -> ejecutarse despues de cada test
     *
     */
     ...
     *COVERAGE
     *
     * coverage -> número de líneas que están cubiertas
     *por tests en un archivo
     */
